...
public interface SellerApi {
    ...
    @Operation(
            ...
            description = "Создает нового продавца в системе",
            responses = {
    ...
    @Operation(
            ...
            description = "Возвращает список всех активных продавцов",
            responses = {
    ...
    @Operation(
            ...
            description = "Возвращает список всех продавцов (включая неактивных)",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Успешный запрос")
            }
    )
    ...
    @Operation(
            ...
            description = "Возвращает информацию о продавце по его идентификатору",
            responses = {
                    @ApiResponse(responseCode = "200", description = "Успешный запрос"),
    ...
    @Operation(
            ...
            description = "Удаляет продавца по идентификатору",
            responses = {
    ...
    @Operation(
            ...
            description = "Обновляет информацию о продавце",
            responses = {
